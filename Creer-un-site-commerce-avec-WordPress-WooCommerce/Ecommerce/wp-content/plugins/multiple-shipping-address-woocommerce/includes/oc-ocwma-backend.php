        ...
        protected static $OCWMA_instance;
            ...
            ?>    
                ...
                <div class="ocwqv-container">
                    <form method="post" >
                      <?php wp_nonce_field( 'ocwqv_nonce_action', 'ocwma_nonce_field' ); ?>   
                            <div class="ocwma_cover_div">
                                <table class="ocwma_data_table">
                                    ...
                                    <tr>
                                        <th>MAX Address</th>
                                        <td>
                                            <input type="number" name="ocwma_max_adress" value="<?php if(!empty(get_option( 'ocwma_max_adress' ))){ echo get_option( 'ocwma_max_adress' ); }else{ echo "10";} ?>">
                                        </td>
                                    </tr>
                                </table>
                            </div>
                            <div class="ocwma_cover_div">
                                <table class="ocwma_data_table">
                                    ...
                                    <tr>
                                        <th>Font color</th>
                                        <td>
                                            <input type="color" name="ocwma_font_clr" value="<?php if(!empty(get_option( 'ocwma_font_clr' ))){ echo get_option( 'ocwma_font_clr' ); }else{ echo "#ffffff";} ?>">
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>Background Color</th>
                                        <td>
                                            <input type="color" name="ocwma_btn_bg_clr" value="<?php if(!empty(get_option( 'ocwma_btn_bg_clr' ))){ echo get_option( 'ocwma_btn_bg_clr' ); }else{ echo "#000000";} ?>">
            ...
            function OCWMA_save_options(){
                if( current_user_can('administrator') ) { 
                    if(isset($_REQUEST['action']) && $_REQUEST['action'] == 'ocwma_save_option'){
                        if(!isset( $_POST['ocwma_nonce_field'] ) || !wp_verify_nonce( $_POST['ocwma_nonce_field'], 'ocwqv_nonce_action' ) ){
